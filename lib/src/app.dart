...
import 'auth.dart';
import 'auto_route/app_auto_route.dart';
import 'data.dart';
...
class Bookstore extends StatefulWidget {
  ...
  const Bookstore({required this.isAutoRoute, super.key});
...
class _BookstoreState extends State<Bookstore> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.isAutoRoute) {
      return MaterialApp.router(routerConfig: _autoRouter.config());
    }
